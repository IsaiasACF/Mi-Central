...
try {
    ...
    $editorPage = video_exports_request('http://web/index.php?section=video-editor&id=' . $videoId . '&editor=1', 'GET', null, $cookieFile);
    ...
    $otherEditorPage = video_exports_request('http://web/index.php?section=video-editor&id=' . $otherVideoId . '&editor=1', 'GET', null, $otherCookieFile);
    ...
    video_exports_assert(is_string($crontab) && str_contains($crontab, 'process-reminders.php') && str_contains($crontab, 'process-video-metadata.php') && str_contains($crontab, 'process-video-exports.php') && str_contains($crontab, 'cleanup-video-files.php'), 'Worker crontab lost reminders, metadata, exports, or cleanup.');
